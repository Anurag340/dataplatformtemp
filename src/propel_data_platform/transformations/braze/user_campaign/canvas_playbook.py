...
class BrazeUserCanvasTransform(BrazeBaseTransform):
    ...
    def row_transform(row):
        return CanvasUtils.extract_user_canvas_details(
    ...
    def _write_to_db(self):
        df = self.spark.sql(
            ...
            lambda row: (
                BrazeUserCanvasTransform.row_transform(row.asDict())
        ...
        df = (
            ...
            .dropDuplicates(["user_id", "type", "id"])
